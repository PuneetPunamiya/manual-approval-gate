...
# Usage: create_kind_cluster <cluster_name>
create_kind_cluster "my-kind-cluster"
...
export RELEASE_YAML="https://storage.googleapis.com/tekton-releases/pipeline/previous/v0.49.0/release.yaml"
