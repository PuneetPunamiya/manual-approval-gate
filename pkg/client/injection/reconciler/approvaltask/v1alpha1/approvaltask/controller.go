...
import (
	...
	versionedscheme "github.com/openshift-pipelines/manual-approval-gate/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "approvaltask-controller"
	defaultFinalizerName       = "approvaltasks.openshiftpipelines.org"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	approvaltaskInformer := approvaltask.Get(ctx)

	lister := approvaltaskInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "openshiftpipelines.org.ApprovalTask"),
	)
